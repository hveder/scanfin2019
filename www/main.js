...
var map = {
	"./editvindata/editvindata.module": [
	...
	"./takevinphotos/takevinphotos.module": [
...
/* harmony import */ var _services_webmobil24_login_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/webmobil24-login.service */ "./src/app/services/webmobil24-login.service.ts");
...
/* harmony import */ var _interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./interceptor/httpconfig.interceptor */ "./src/app/interceptor/httpconfig.interceptor.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_webmobil24_login_service__WEBPACK_IMPORTED_MODULE_8__["Webmobil24LoginService"],
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_15__["HTTP_INTERCEPTORS"], useClass: _interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_16__["HttpConfigInterceptor"], multi: true },
...
/***/ "./src/app/services/webmobil24-login.service.ts":
/*!******************************************************!*\
  !*** ./src/app/services/webmobil24-login.service.ts ***!
  \******************************************************/
/*! exports provided: Webmobil24LoginService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Webmobil24LoginService", function() { return Webmobil24LoginService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _webservicecalls_webservicecalls_tokenmanager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../webservicecalls/webservicecalls.tokenmanager */ "./src/app/webservicecalls/webservicecalls.tokenmanager.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");




var Webmobil24Credentials = /** @class */ (function () {
    function Webmobil24Credentials(wm24_dealer_id, wm24_dealer_login, token, company) {
        this.wm24_dealer_id = wm24_dealer_id;
        this.wm24_dealer_login = wm24_dealer_login;
        this.token = token;
        this.company = company;
    }
    return Webmobil24Credentials;
}());
var Webmobil24LoginService = /** @class */ (function () {
    function Webmobil24LoginService(http) {
        this.http = http;
    }
    Webmobil24LoginService_1 = Webmobil24LoginService;
    Webmobil24LoginService.prototype.fnWm24Login = function (username, password) {
        var _this = this;
        var that = this;
        var promise = new Promise(function (resolve, reject) {
            var apiURL = "" + Webmobil24LoginService_1.apiRoot;
            var tm = new _webservicecalls_webservicecalls_tokenmanager__WEBPACK_IMPORTED_MODULE_2__["WebservicecallsTokenanager"]();
            var paramsData = {
                'username': username,
                'password': password
            };
    ...
    Webmobil24LoginService.prototype.callfnWm24Login = function (username, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fnWm24Login(username, password)];
                    case 1:
                        _a.sent();
    ...
    Webmobil24LoginService.prototype.setToken = function (cLog) {
        this.token = cLog;
    };
...
/***/ "./src/app/webservicecalls/webservicecalls.tokenmanager.ts":
/*!*****************************************************************!*\
  !*** ./src/app/webservicecalls/webservicecalls.tokenmanager.ts ***!
  \*****************************************************************/
/*! exports provided: WebservicecallsTokenanager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WebservicecallsTokenanager", function() { return WebservicecallsTokenanager; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var WebservicecallsTokenanager = /** @class */ (function () {
    function WebservicecallsTokenanager() {
        this.tokenKey = 'rmt_app_token';
        this.wm24_login_datas = 'spin_360_token';
        this.wm24_ltoken = 'wm_24_token';
        this.vin_Data = 'vin_';
    }
    WebservicecallsTokenanager.prototype.store = function (content) {
        localStorage.setItem(this.tokenKey, JSON.stringify(content));
    };
    WebservicecallsTokenanager.prototype.retrieve = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var storedToken;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                return [2 /*return*/, JSON.parse(storedToken)];
            });
        });
    };
    WebservicecallsTokenanager.prototype.store_wm24_login_datas = function (content) {
        localStorage.setItem(this.wm24_login_datas, JSON.stringify(content));
    };
    WebservicecallsTokenanager.prototype.retrieve_wm24_login_datas = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var storedToken;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, localStorage.getItem(this.wm24_login_datas)];
                    case 1:
                        storedToken = _a.sent();
                        if (!storedToken)
                            throw 'no token found';
    ...
    WebservicecallsTokenanager.prototype.storeWM24OcToken = function (content) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WebservicecallsTokenanager.prototype.store_vin_data = function (vin, xml) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    WebservicecallsTokenanager.prototype.get_vin_data = function (vin) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var vinXml;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, localStorage.getItem(this.vin_Data + vin)];
                    case 1:
                        vinXml = _a.sent();
                        if (!vinXml)
                            throw 'no token found';
                        return [2 /*return*/, JSON.parse(vinXml)];
                }
            });
        });
    };
    WebservicecallsTokenanager = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])()
    ], WebservicecallsTokenanager);
    return WebservicecallsTokenanager;
}());
...
module.exports = __webpack_require__(/*! /Users/wm24dc/trialApp/ScanFinApp2/src/main.ts */"./src/main.ts");
